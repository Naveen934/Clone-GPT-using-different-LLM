...
def mock_session_state(monkeypatch):
    ...
    session_state = {'api_key': 'fake-api-key'}
...
def test_llm_response_huggingface(mock_invoke, mock_session_state):
    # Define what the mocked HuggingFace response will be
...
@mock.patch('app.ChatGoogleGenerativeAI.invoke')
def test_llm_response_gemini(mock_invoke, mock_session_state):
    # Define what the mocked Gemini response will be
    mock_invoke.return_value = mock.Mock(content="This is a mocked response from Gemini.")
